...
**[Try the App →](https://disease-prediction-based-on-symptoms-tb54b3snkpncduuwybu9w2.streamlit.app/)**
...
- **Multiple Algorithms**: Choose from 5 different ML models for prediction.
...
- Dataset sourced for educational and research purposes
